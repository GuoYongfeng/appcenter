...
class DashboardV2 extends React.Component {
    ...
    componentWillUnmount() {
        $(this.refs.chartBar).data('plot').shutdown();
        ...
        return (
            <ContentWrapper>
                ...
                <Row className="mb-lg">
                    <Col sm={ 3 } xs={ 6 } className="text-center">
                        <p>Current Project</p>
                        <div className="text-center pv-lg">
                            <div data-easypiechart="" data-percent="60" data-animate="{duration: 800, enabled: true}" data-bar-color="#23b7e5" data-track-Color="#edf2f6" data-scale-Color="false" data-line-width="2" data-line-cap="round" data-size="130" className="easypie-chart easypie-chart-md">
                                <span>60%</span>
                            </div>
                        </div>
                    </Col>
                    <Col sm={ 3 } xs={ 6 } className="text-center">
                        ...
                        <div className="text-center pv-lg">
                            <div data-easypiechart="" data-percent="30" data-animate="{duration: 800, enabled: true}" data-bar-color="#f532e5" data-track-Color="#edf2f6" data-scale-Color="false" data-line-width="2" data-line-cap="round" data-size="130" className="easypie-chart easypie-chart-md">
                                <span>30%</span>
                            </div>
                        </div>
                    </Col>
                    <Col sm={ 3 } xs={ 6 } className="text-center">
                        <p>Space Usage</p>
                        <div className="text-center pv-lg">
                            <div data-easypiechart="" data-percent="50" data-animate="{duration: 800, enabled: true}" data-bar-color="#7266ba" data-track-Color="#edf2f6" data-scale-Color="false" data-line-width="2" data-line-cap="round" data-size="130" className="easypie-chart easypie-chart-md">
                                <span>50%</span>
                            </div>
                        </div>
                    </Col>
                    <Col sm={ 3 } xs={ 6 } className="text-center">
                        <p>Interactions</p>
                        <div className="text-center pv-lg">
                            <div data-easypiechart="" data-percent="75" data-animate="{duration: 800, enabled: true}" data-bar-color="#ff902b" data-track-Color="#edf2f6" data-scale-Color="false" data-line-width="2" data-line-cap="round" data-size="130" className="easypie-chart easypie-chart-md">
                                <span>75%</span>
                            </div>
                        </div>
                    </Col>
