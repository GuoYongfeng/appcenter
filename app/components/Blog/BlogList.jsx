                    ...
                    <Col lg={ 9 }>
                        <Row>
                            ...
                            <Col lg={ 4 }>
                                ...
                                <Panel className="bg-primary b0">
                                    <h3 className="mv-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h3>
                                    <p className="clearfix">
                                        <span className="pull-left">
                                            <small className="mr-sm">By <a href="" className="text-white">Erica Castro</a></small>
                                            <small className="mr-sm">May 03, 2015</small>
                                         </span>
                                        <span className="pull-right">
                                            <small>
                            ...
                            <Col lg={ 4 }>
                                ...
                                <Panel className="bg-purple b0">
                                    <h3 className="mv-lg">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h3>
                                    <p className="clearfix">
                                        <span className="pull-left">
                                            <small className="mr-sm">By <a href="">Ava Chavez</a></small>
                                            <small className="mr-sm">May 03, 2015</small>
                                        </span>
                                        <span className="pull-right">
                                            <small>
