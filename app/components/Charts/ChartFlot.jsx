...
class ChartFlot extends React.Component {
    ...
    componentWillUnmount() {
        $(this.refs.chartArea).data('plot').shutdown();
        $(this.refs.chartSpline).data('plot').shutdown();
        $(this.refs.chartBar).data('plot').shutdown();
        $(this.refs.chartBarStacked).data('plot').shutdown();
        $(this.refs.chartLine).data('plot').shutdown();
        $(this.refs.chartPie).data('plot').shutdown();
        $(this.refs.chartDonut).data('plot').shutdown();
    }
